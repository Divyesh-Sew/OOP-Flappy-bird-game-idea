...
public:
    ...
    bool passed = false; // of pipe gepasseerd is voor score

    Pipe(float x, float gapY) {
        texture.loadFromFile("C:\\Users\\User\\Desktop\\FlapperBIRD\\FlappyBirdFinalProject\\assets\\pipe.png"); // pipe plaatje laden
        ...
        topPipe.setScale(1.f, -topHeight / pipeHeight); // bovenste pipe gespiegeld omhoog schalen
        topPipe.setPosition(x, gapY - gapSize / 2.f);

        bottomPipe.setScale(1.f, bottomHeight / pipeHeight); // onderste pipe naar beneden schalen
...
public:
    ...
    Bird() {
        texture.loadFromFile("C:\\Users\\User\\Desktop\\FlapperBIRD\\FlappyBirdFinalProject\\assets\\raket.png"); // Trumpraket plaatje
...
void drawHitbox(sf::RenderWindow& window, const sf::FloatRect& rect) {
    ...
    box.setFillColor(sf::Color::Transparent); // geen fill
...
public:
    Game() : window(sf::VideoMode(1080, 720), "Flappy Bird - SFML 2.6.2") {
        ...
        backgroundTex.loadFromFile("C:\\Users\\User\\Desktop\\FlapperBIRD\\FlappyBirdFinalProject\\assets\\background.png"); // achtergrond plaatje laden
        ...
        font.loadFromFile("C:\\Users\\User\\Desktop\\FlapperBIRD\\FlappyBirdFinalProject\\assets\\FlappyBirdy.ttf"); // lettertype
...
private:
    ...
    void update(float dt) {
        ...
        if (spawnTimer >= 2.0f) { // elke 2 sec pipe erbij
            ...
            pipes.emplace_back(1100, gapY); // nieuwe pipe aan rechterkant
            spawnTimer = 0;
        }
